...
- PHP 8.3 (Drupal 11 requires 8.3+; PHP 8.5 is not yet officially supported,
  so install a dedicated `php@8.3` via Homebrew rather than using the system PHP)
...
Scarfolk theme (not a subtheme sitting on top of it), so everything is editable
